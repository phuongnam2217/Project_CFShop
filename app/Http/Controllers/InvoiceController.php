...
class InvoiceController extends Controller
{
    ...
    public function showTime($id){
        ...
        if($id == 1) {
            ...
            $tables = Table::all();
            $orders = Order::whereBetween('check_out',[$startDay,$endDay])->paginate(10);
        ...
        if($id == 2){
            ...
            $tables = Table::all();
            $orders = Order::whereBetween('check_out',[$startWeek,$endWeek])->paginate(10);
        ...
        if($id == 3){
            ...
            $tables = Table::all();
            $orders = Order::whereBetween('check_out',[$startMonth,$endMonth])->paginate(10);
